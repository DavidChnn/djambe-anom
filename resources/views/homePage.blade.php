...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="">
        <!-- Navbar -->
        <Navbar class="flex justify-between p-2 md:px-10 md:py-4 lg:px-20 lg:py-4 xl:px-56 xl:py-6 shadow-xl bg-cover bg-[url('/public/images/bgawan.jpg')] opacity-85 border-b-4 border-[#584d33]">
            <div>
                <!-- LOGO DJAMBENOM -->
                <a href="#">
                    <img src="{{ url('public/images/logodjambe1.png') }}" alt="Deskripsi Gambar" class="w-56">
                </a>
        ...
        <!-- Navbar -->
        <!-- Content -->
        <div class="bg-cover bg-[url('/public/images/bg-tree.jpg')] text-white grid grid-cols-2 justify-center py-10 sm:py-10 lg:py-40 sm:px-20 gap-4">
            <div class="sm:mx-10 lg:mx-20 flex justify-center items-center sm:hidden">
                <img src="{{ url('public/images/djambetangan.jpg') }}" alt="Deskripsi Gambar" class="w-28 sm:w-86 md:w-80 lg:w-fit xl:w-fit 2xl:w-[350px] rounded-xl">
            </div>
             <!-- component -->
                ...
                <div id="default-carousel" class="relative" data-carousel="static">
                    ...
                    <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-[450px] 2xl:h-96">
                        ...
                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                            ...
                            <img src="{{ url('public/images/djambeawan.jpg') }}" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                        </div>
                        <!-- Item 2 -->
                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                            <img src="{{ url('public/images/djambetangan.jpg') }}" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                        </div>
                        <!-- Item 3 -->
                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                            <img src="{{ url('public/images/djambeasap1.jpg') }}" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="...">
                        </div>
                    </div>
                    <!-- Slider indicators -->
                ...
                <div class="px-2">
                    ...
                    <a href="https://wa.me/6282229749706" class="flex xl:my-8 sm:my-4 items-center" target="_blank">
                        <button class="flex bg-green-900 hover:bg-green-300 py-2 pr-4 rounded-xl">
                            <img src="{{ url('public/images/whatsapp.png') }}" alt="logo WhatsApp" class="sm:w-10 w-4 mx-4">
        ...
        <!-- <div class="">
            <img src="{{ url('public/images/vector.png')}}" alt="" class="absolute w-full bottom-0 hidden sm:block sm:-translate-y- md:-translate-y-[410px] lg:translate-y-14 xl:translate-y-16 2xl:-translate-y-36">
        </div> -->
            ...
            <div class="relative grid sm:grid-cols-2 lg:grid-cols-4 px-20 py-10 gap-10">
                <div class="bg-white h-50 py-2 px-4 shadow-xl rounded-xl">
                    <div class="flex justify-center items-center">
                        <img src="{{ url('public/images/strong.png') }}" alt="Deskripsi Gambar" class="w-20 md:w-32 lg:w-40">
                    </div>
                ...
                <div class="bg-white h-50 py-2 px-4 shadow-xl rounded-xl">
                    <div class="flex justify-center items-center">
                        <img src="{{ url('public/images/foster-family.png') }}" alt="Deskripsi Gambar" class="w-20 md:w-32 lg:w-40">
                    </div>
                    <h1 class="text-md sm:text-lg xl:text-xl text-center font-bold">
                ...
                <div class="bg-white h-50 py-2 px-4 shadow-xl rounded-xl">
                    <div class="flex justify-center items-center">
                        <img src="{{ url('public/images/milk-tooth.png') }}" alt="Deskripsi Gambar" class="w-20 md:w-32 lg:w-40">
                    </div>
                    <h1 class="text-md sm:text-lg xl:text-xl text-center font-bold">
                        Pemutih Gigi
                    </h1>
                ...
                <div class="bg-white h-50 py-2 px-4 shadow-xl rounded-xl">
                    <div class="flex justify-center items-center">
                        <img src="{{ url('public/images/fight.png') }}" alt="Deskripsi Gambar" class="w-20 md:w-32 lg:w-40">
                    </div>
                    <h1 class="text-md sm:text-lg xl:text-xl text-center font-bold">
                        Melawan Kanker
                    </h1>
        ...
        <div class="bg-cover bg-[url('/public/images/bg-grass.jpeg')] justify-center py-10">
            <div id="gallery">
                ...
                <div class="container mx-auto px-5 py-2 lg:px-32 lg:pt-24">
                    ...
                    <div class="flex w-1/2 flex-wrap">
                        ...
                        <img
                            ...
                            src="{{ url('public/images/djambe.jpg') }}" />
                        </div>
                        <div class="w-1/2 p-1 md:p-2">
                        <img
                            alt="gallery"
                            class="block h-full w-full rounded-lg object-cover object-center"
                            src="{{ url('public/images/djambeawan.jpg') }}" />
                        </div>
                        <div class="w-full p-1 md:p-2">
                        <img
                            alt="gallery"
                            class="block h-full w-full rounded-lg object-cover object-center"
                            src="{{ url('public/images/djambetangan.jpg') }}" />
                        </div>
                    </div>
                    <div class="flex w-1/2 flex-wrap">
                        <div class="w-full p-1 md:p-2">
                        <img
                            alt="gallery"
                            class="block h-full w-full rounded-lg object-cover object-center"
                            src="{{ url('public/images/djambeasap1.jpg') }}" />
                        </div>
                        <div class="w-1/2 p-1 md:p-2">
                        <img
                            alt="gallery"
                            class="block h-full w-full rounded-lg object-cover object-center"
                            src="{{ url('public/images/djambepagar.jpg') }}" />
                        </div>
                        <div class="w-1/2 p-1 md:p-2">
                        <img
                            alt="gallery"
                            class="block h-full w-full rounded-lg object-cover object-center"
                            src="{{ url('public/images/djambeasap2.jpg') }}" />
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <div id="review" class="md:py-10 lg:py-20 bg-gray-300">
                ...
                <div class="relative grid sm:grid-cols-2 lg:grid-cols-4 px-20 py-10 gap-10">
                    <div class="bg-white h-fit p-4 shadow-xl rounded-xl">
                        <div class="flex justify-center items-center">
                            <img src="{{ url('public/images/djambe.jpg') }}" alt="Deskripsi Gambar" class="w-20 md:w-32 lg:w-40">
                        </div>
